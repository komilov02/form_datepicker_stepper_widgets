...
class StepperIndexedExampleScreen extends StatefulWidget {
  const StepperIndexedExampleScreen({super.key});

  @override
  State<StepperIndexedExampleScreen> createState() => _StepperIndexedExampleScreenState();
}

class _StepperIndexedExampleScreenState extends State<StepperIndexedExampleScreen> {
